...
module.exports = {
    ...
    BOTSK: process.env.BOT_NAME === undefined ? '𝗪𝗛𝗜𝗧𝗘𝟰𝗫𝗫࿐' : process.env.BOT_NAME,
    ...
    SLINK: process.env.SOCIAL_MEDIA === undefined ? 'https://www.instagram.com/justbanthatthing/' : process.env.SOCIAL_MEDIA,
